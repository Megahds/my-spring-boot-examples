...
import com.megah.multipledatasourcesjdbc.dao.SQLServerDao;
...
public class SQLServerController {
	...
	public ResponseEntity<Object> findAll() {
		...
		List<Person> listPerson = sqlServerDao.findAll();
	...
	public ResponseEntity<Object> add(@RequestBody Person person) {
		...
		Integer check = sqlServerDao.add(person);
	...
	public ResponseEntity<Object> delete(@PathVariable("id") Integer id) {
		...
		Integer check = sqlServerDao.delete(id);
